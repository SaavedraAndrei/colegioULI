<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Gestione y cierre su cuenta de otros dispositivos.') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Desde esta sección podrá cerrar la sesión de su cuenta en los dispositivos en los que se encuentre activo.') }}
        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Por favor ingresa tu contraseña para confirmar el cierre de sesión de otros dispositivos.') }}
